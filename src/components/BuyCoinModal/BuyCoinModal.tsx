...
function BuyCoinModal({
  ...
  <div className={styles.overlay}    onClick={(event)=>handleOverlayClick(event)}>
    <div className={styles.container}>
      ...
      <div className={styles.price}>
        Total cost:    {formatLargeNumbers(
        quantity * Number(coinData?.priceUsd)
      )}$
      </div>
      <label className={styles.quantity}>
        Quantity:
        <AiOutlineMinusSquare onClick={handleDecreaseQuantity} className={styles.icon_quantity}/>
        <div className={styles.title_quantity}>{quantity}</div>
        <AiOutlinePlusSquare onClick={handleIncreaseQuantity} className={styles.icon_quantity}/>
      </label>
